    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      {renderTrigger ? (
        ...
        <Button
          type="button"
          variant="outline"
          className="justify-start text-left border-0 sm:justify-center sm:text-center sm:border"
          onClick={openDialog}
        >
      ...
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Choose which ingredients from {recipeName} to add to your shopping
            list.
          </DialogDescription>
        </DialogHeader>
                  ...
                  <div className="grid gap-4 md:grid-cols-[minmax(0,1.3fr)_minmax(0,0.8fr)_minmax(0,0.7fr)] md:items-end">
                    <div className="flex my-auto">
                      <Label
                        ...
                        htmlFor={`shopping-ingredient-${draft.ingredientId}`}
                      >
                        <input
                          type="checkbox"
